    ...
    <div className="container-footer">
        ...
        <div className="pull-right">
            <p className="text-muted"> 
                ...
                &nbsp;|&nbsp;
                <a href="mailto:curation-support@ebrains.eu?subject=Metadata Wizard Issue :
                 <Enter short description here>&body=Dear Curation Team,%0D%0A%0D%0A%0D%0A">Report issue (Email)</a> 
            </p>
        </div>
    </div>
</footer>
