...
export default function Contributors_remove({ form, onChange, data }) {
                        ...
                        {!field.isCustom ? (
                            <Form.Item label={`Select Contributor`} required style={{ flex: 1 }}>
                                <Select
                                    showSearch
                                    style={{ minWidth: 240 }}
                                    value={field.selectedContributor} // Bind value here
                                    onChange={(value) => handleFieldChange(index, 'selectedContributor', value)} // Update on change
